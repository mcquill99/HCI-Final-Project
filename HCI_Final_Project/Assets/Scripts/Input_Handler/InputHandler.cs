    ...
    public class InputHandler : MonoBehaviour
    {
        ...
        #region Custom Methods
            ...
            void GetMovementInputData()
            {
                ...
                //Changed this to hold crouch by adding || GetKeyUp
                movementInputData.CrouchHeld = Input.GetKey(KeyCode.LeftControl);
                if(movementInputData.IsCrouching)
                    movementInputData.CrouchClicked = Input.GetKeyUp(KeyCode.LeftControl);// || Input.GetKeyUp(KeyCode.LeftControl);
                else
                    movementInputData.CrouchClicked = Input.GetKeyDown(KeyCode.LeftControl);// || Input.GetKeyUp(KeyCode.LeftControl);
